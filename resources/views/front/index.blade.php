...
{{--    </div>--}}
                ...
                <div class="container-fluid clearfix">
                    ...
                    <div class="secondary-menu">
                        <ul>
                            <li class="search-btn">
                                @auth
                                    <a href="{{ url(auth()->user()->roles->pluck('name')[0].'/dashboard') }}" class="btn btn-primary shadow">Dashboard</a>
                                @else
                                    @if (Route::has('login'))
                                        <div class="">
    ...
    <div class="page-content bg-white">
        ...
        <!-- Main Banner -->
        <div class="main-banner" style="background-image:url({{ asset('assets/front/images/main-banner/bg1.jpg') }});">
            <div class="container inner-content">
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-6 col-sm-7">
                        <h6 class="title-ext text-primary">One Stop For All Health Care Solution</h6>
                        <h1>Protect Your Health And Take Care To Of Your Health</h1>
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="btn btn-secondary btn-lg shadow">Register</a>
                        @endif
                    </div>
                    <div class="col-lg-5 col-md-6 col-sm-5">
                        <div class="banner-img">
                            <img src="{{ asset('assets/front/images/main-banner/doctor.png') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-30">
                        <div class="about-thumb-area">
                            <ul>
                                <li><img class="about-thumb1" src="{{ asset('assets/front/images/about/pic-1.jpg') }}" alt=""></li>
                                <li><img class="about-thumb2" src="{{ asset('assets/front/images/about/pic-2.jpg') }}" alt=""></li>
                                <li><img class="about-thumb3" src="{{ asset('assets/front/images/about/pic-3.jpg') }}" alt=""></li>
        ...
        <!-- Our Progress -->
        <section class="section-area section-sp5 work-area" style="background-image: url({{ asset('assets/front/images/background/line-bg1.png') }}); background-repeat: no-repeat; background-position: center; background-size: 100%;">
        ...
        <section class="section-area account-wraper1">
            <div class="container-fluid">
                <div class="appointment-inner section-sp2" style="background-image: url({{ asset('assets/front/images/appointment/line-bg.png') }}); background-repeat: no-repeat; background-position: 20px 140px;">
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-7 col-lg-6 col-md-6">
                                <div class="appointment-thumb">
                                    ...
                                    <div class="images-group">
                                        ...
                                        <img class="img2" src="{{ asset('assets/front/images/appointment/map-pin.png') }}" alt="">
                                        <img class="img3" src="{{ asset('assets/front/images/appointment/setting.png') }}" alt="">
        ...
        <section class="section-area section-sp1 service-wraper">
            ...
            <img class="pt-img1 animate-rotate" src="{{ asset('assets/front/images/shap/line-circle-blue.png') }}" alt="">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 text-center">
                        <div class="thumb-wraper">
                            <img class="bg-img" src="{{ asset('assets/front/images/testimonials/shape.png') }}" alt="">
                            <ul>
                                <li data-member="1"><a href="javascript:void(0);"><img src="{{ asset('assets/front/images/testimonials/pic1.jpg') }}" alt=""/></a></li>
                                <li data-member="2"><a href="javascript:void(0);"><img src="{{ asset('assets/front/images/testimonials/pic2.jpg') }}" alt=""/></a></li>
                                <li data-member="3"><a href="javascript:void(0);"><img src="{{ asset('assets/front/images/testimonials/pic3.jpg') }}" alt=""/></a></li>
                                <li data-member="4"><a href="javascript:void(0);"><img src="{{ asset('assets/front/images/testimonials/pic4.jpg') }}" alt=""/></a></li>
                                <li data-member="5"><a href="javascript:void(0);"><img src="{{ asset('assets/front/images/testimonials/pic5.jpg') }}" alt=""/></a></li>
                                <li data-member="6"><a href="javascript:void(0);"><img src="{{ asset('assets/front/images/testimonials/pic6.jpg') }}" alt=""/></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6">
    ...
    <!-- Footer ==== -->
    <footer class="footer" style="background-image:url({{ asset('assets/front/images/background/footer.jpg') }});">
        <!-- Footer Top -->
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6">
                        <div class="widget widget_form">
                            ...
                            <div class="footer-social-link">
                                <ul>
                                    <li><a target="_blank" href="https://www.facebook.com/"><img src="{{ asset('assets/front/images/social/facebook.png') }}" alt=""/></a></li>
                                    <li><a target="_blank" href="https://twitter.com/"><img src="{{ asset('assets/front/images/social/twitter.png') }}" alt=""/></a></li>
                                    <li><a target="_blank" href="https://www.instagram.com/"><img src="{{ asset('assets/front/images/social/instagram.png') }}" alt=""/></a></li>
                                    <li><a target="_blank" href="https://www.linkedin.com/"><img src="{{ asset('assets/front/images/social/linkedin.png') }}" alt=""/></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="footer-bottom">
                <div class="row">
                    <div class="col-12 text-center">
                        <p class="copyright-text">Copyright © 2022 <a href="{{ url('/') }}" class="text-secondary">MedLink</a></p>
                    </div>
                </div>
            </div>
        </div>
